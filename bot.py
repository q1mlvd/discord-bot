...
async def admin_boost_chances(interaction: discord.Interaction):
    try:
        ...
        # Создаем кейсы с УВЕЛИЧЕННЫМИ ШАНСАМИ (+3-5%)
        boosted_cases = [
            # ID 1 - Малый кейс (+3% к средним и большим наградам)
            ('📦 Малый кейс', 50, json.dumps([
                {'type': 'coins', 'amount': [10, 40], 'chance': 0.77, 'description': 'Небольшая сумма монет'},  # -3%
                {'type': 'coins', 'amount': [41, 100], 'chance': 0.18, 'description': 'Средняя сумма монет'},   # +3%
                {'type': 'coins', 'amount': [101, 300], 'chance': 0.05, 'description': 'Хорошая сумма монет'}   # 0%
            ])),
            # ID 2 - Средний кейс (+4% к предмету и большим монетам)
            ('📦 Средний кейс', 150, json.dumps([
                {'type': 'coins', 'amount': [50, 120], 'chance': 0.66, 'description': 'Надежная сумма монет'},  # -4%
                {'type': 'coins', 'amount': [121, 300], 'chance': 0.2, 'description': 'Отличная сумма монет'},  # 0%
                {'type': 'special_item', 'name': 'Магический свиток', 'chance': 0.09, 'description': 'Увеличивает выигрыш в рулетке на 25%'},  # +4%
                {'type': 'coins', 'amount': [301, 800], 'chance': 0.05, 'description': 'Отличный выигрыш'}      # 0%
            ])),
            # ID 3 - Большой кейс (+4% к предмету и бонусу)
            ('💎 Большой кейс', 500, json.dumps([
                {'type': 'coins', 'amount': [200, 400], 'chance': 0.56, 'description': 'Солидная сумма'},       # -4%
                {'type': 'coins', 'amount': [401, 1000], 'chance': 0.25, 'description': 'Очень хорошая сумма'}, # 0%
                {'type': 'special_item', 'name': 'Золотой амулет', 'chance': 0.12, 'description': 'Увеличивает ежедневную награду на 20%'},  # +4%
                {'type': 'bonus', 'multiplier': 1.5, 'duration': 24, 'chance': 0.07, 'description': 'Временный бонус x1.5 на 24 часа'}        # 0%
            ])),
            # ID 4 - Элитный кейс (+3% к предмету и бонусу, -3% к минусу)
            ('👑 Элитный кейс', 1000, json.dumps([
                {'type': 'coins', 'amount': [500, 1000], 'chance': 0.3, 'description': 'Элитные монеты'},       # 0%
                {'type': 'coins', 'amount': [-300, -100], 'chance': 0.17, 'description': 'Неудача (потеря монет)'},  # -3%
                {'type': 'special_item', 'name': 'Древний артефакт', 'chance': 0.18, 'description': 'Мощный множитель наград x1.5'},  # +3%
                {'type': 'bonus', 'multiplier': 2.0, 'duration': 48, 'chance': 0.13, 'description': 'Временный бонус x2.0 на 48 часов'},  # +3%
                {'type': 'coins', 'amount': [1001, 3000], 'chance': 0.15, 'description': 'Элитный выигрыш'},    # 0%
                {'type': 'coins', 'amount': [3001, 6000], 'chance': 0.07, 'description': 'Элитный джекпот'}     # -3%
            ])),
            # ID 5 - Секретный кейс (+3% к предмету и бонусу, -3% к минусу)
            ('🔮 Секретный кейс', 2000, json.dumps([
                {'type': 'coins', 'amount': [800, 1500], 'chance': 0.3, 'description': 'Секретные монеты'},     # 0%
                {'type': 'coins', 'amount': [-1000, -500], 'chance': 0.12, 'description': 'Секретный риск'},    # -3%
                {'type': 'special_item', 'name': 'Мифический предмет', 'chance': 0.18, 'description': 'Легендарный множитель наград x2.0'},  # +3%
                {'type': 'bonus', 'multiplier': 3.0, 'duration': 72, 'chance': 0.13, 'description': 'Временный бонус x3.0 на 72 часа'},  # +3%
                {'type': 'coins', 'amount': [1501, 3000], 'chance': 0.15, 'description': 'Секретная удача'},    # 0%
                {'type': 'coins', 'amount': [4001, 7000], 'chance': 0.12, 'description': 'Секретный клад'}      # -3%
            ])),
            # ID 6 - Боевой кейс (+4% к предметам, -4% к минусу)
            ('⚔️ Боевой кейс', 3500, json.dumps([
                {'type': 'coins', 'amount': [1000, 3000], 'chance': 0.4, 'description': 'Боевая награда'},      # 0%
                {'type': 'coins', 'amount': [-1000, -500], 'chance': 0.06, 'description': 'Боевые потери'},     # -4%
                {'type': 'special_item', 'name': 'Перчатка вора', 'chance': 0.19, 'description': 'Увеличивает шанс кражи на 20%'},  # +4%
                {'type': 'bonus', 'multiplier': 2.5, 'duration': 48, 'chance': 0.1, 'description': 'Временный бонус x2.5 на 48 часов'},  # 0%
                {'type': 'coins', 'amount': [3001, 6000], 'chance': 0.15, 'description': 'Боевой трофей'},      # 0%
                {'type': 'special_item', 'name': 'Тотем защиты', 'chance': 0.1, 'description': '+20% к шансу победы в дуэлях'}  # 0%
            ])),
            # ID 7 - Премиум кейс (+5% к предметам, -5% к минусу)
            ('💎 Премиум кейс', 5000, json.dumps([
                {'type': 'coins', 'amount': [2000, 4000], 'chance': 0.4, 'description': 'Премиум монеты'},      # 0%
                {'type': 'special_item', 'name': 'Золотой амулет', 'chance': 0.25, 'description': 'Увеличивает ежедневную награду на 20%'},  # +5%
                {'type': 'bonus', 'multiplier': 3.0, 'duration': 72, 'chance': 0.1, 'description': 'Временный бонус x3.0 на 72 часа'},  # 0%
                {'type': 'coins', 'amount': [-2000, -1000], 'chance': 0.05, 'description': 'Премиум риск'},     # -5%
                {'type': 'coins', 'amount': [5001, 8000], 'chance': 0.1, 'description': 'Премиум выигрыш'},     # 0%
                {'type': 'special_item', 'name': 'Кристалл маны', 'chance': 0.1, 'description': 'Умножает все награды x1.3'}  # 0%
            ])),
            # ID 8 - Адский кейс (+4% к предметам, -4% к минусу)
            ('🔥 Адский кейс', 7500, json.dumps([
                {'type': 'coins', 'amount': [3000, 6000], 'chance': 0.35, 'description': 'Адское богатство'},   # 0%
                {'type': 'coins', 'amount': [-3000, -2000], 'chance': 0.11, 'description': 'Адские потери'},    # -4%
                {'type': 'special_item', 'name': 'Плащ тени', 'chance': 0.24, 'description': '+15% к шансу кражи'},  # +4%
                {'type': 'bonus', 'multiplier': 3.5, 'duration': 96, 'chance': 0.1, 'description': 'Временный бонус x3.5 на 96 часов'},  # 0%
                {'type': 'coins', 'amount': [6001, 10000], 'chance': 0.1, 'description': 'Адский куш'},         # 0%
                {'type': 'special_item', 'name': 'Древний артефакт', 'chance': 0.1, 'description': 'Мощный множитель наград x1.5'}  # 0%
            ])),
            # ID 9 - Легендарный кейс (+4% к предметам, -4% к минусу)
            ('⚡ Легендарный кейс', 10000, json.dumps([
                {'type': 'coins', 'amount': [5000, 8000], 'chance': 0.3, 'description': 'Легендарные монеты'},  # 0%
                {'type': 'special_item', 'name': 'Кольцо удачи', 'chance': 0.24, 'description': '+15% к наградам из кейсов'},  # +4%
                {'type': 'bonus', 'multiplier': 4.0, 'duration': 120, 'chance': 0.1, 'description': 'Временный бонус x4.0 на 120 часов'},  # 0%
                {'type': 'coins', 'amount': [-4000, -2000], 'chance': 0.06, 'description': 'Легендарный риск'}, # -4%
                {'type': 'coins', 'amount': [8001, 15000], 'chance': 0.15, 'description': 'Легендарный выигрыш'}, # 0%
                {'type': 'special_item', 'name': 'Карточный шулер', 'chance': 0.15, 'description': '+15% к выигрышу в блэкджеке'}  # 0%
            ])),
            # ID 10 - Космический кейс (+4% к предметам, -4% к минусу)
            ('🌌 Космический кейс', 15000, json.dumps([
                {'type': 'coins', 'amount': [8000, 15000], 'chance': 0.3, 'description': 'Космическое богатство'}, # 0%
                {'type': 'special_item', 'name': 'Ожерелье мудрости', 'chance': 0.24, 'description': '+15% к опыту'},  # +4%
                {'type': 'bonus', 'multiplier': 4.5, 'duration': 144, 'chance': 0.1, 'description': 'Временный бонус x4.5 на 144 часа'},  # 0%
                {'type': 'coins', 'amount': [-6000, -4000], 'chance': 0.06, 'description': 'Космические потери'}, # -4%
                {'type': 'coins', 'amount': [15001, 25000], 'chance': 0.15, 'description': 'Космический куш'},   # 0%
                {'type': 'special_item', 'name': 'Руна богатства', 'chance': 0.15, 'description': '-10% к комиссии переводов'}  # 0%
            ])),
            # ID 11 - Кристальный кейс (+4% к предметам, -4% к минусу)
            ('💠 Кристальный кейс', 20000, json.dumps([
                {'type': 'coins', 'amount': [10000, 20000], 'chance': 0.3, 'description': 'Кристальные монеты'}, # 0%
                {'type': 'special_item', 'name': 'Кристалл маны', 'chance': 0.19, 'description': 'Умножает все награды x1.3'},  # +4%
                {'type': 'bonus', 'multiplier': 5.0, 'duration': 168, 'chance': 0.1, 'description': 'Временный бонус x5.0 на 168 часов'},  # 0%
                {'type': 'coins', 'amount': [-8000, -5000], 'chance': 0.06, 'description': 'Кристальный риск'},  # -4%
                {'type': 'coins', 'amount': [20001, 30000], 'chance': 0.15, 'description': 'Кристальный выигрыш'}, # 0%
                {'type': 'special_item', 'name': 'Зелье удачи', 'chance': 0.2, 'description': '+10% ко всем наградам'}  # 0%
            ])),
            # ID 12 - Теневой кейс (+4% к предметам, -4% к минусу)
            ('👁️ Теневой кейс', 25000, json.dumps([
                {'type': 'coins', 'amount': [12000, 22000], 'chance': 0.3, 'description': 'Теневые монеты'},     # 0%
                {'type': 'special_item', 'name': 'Плащ тени', 'chance': 0.19, 'description': '+15% к шансу кражи'},  # +4%
                {'type': 'bonus', 'multiplier': 5.5, 'duration': 192, 'chance': 0.1, 'description': 'Временный бонус x5.5 на 192 часа'},  # 0%
                {'type': 'coins', 'amount': [-10000, -6000], 'chance': 0.06, 'description': 'Теневые потери'},   # -4%
                {'type': 'coins', 'amount': [22001, 35000], 'chance': 0.15, 'description': 'Теневой куш'},       # 0%
                {'type': 'special_item', 'name': 'Защитный талисман', 'chance': 0.2, 'description': '-50% к шансу кражи у вас'}  # 0%
            ])),
            # ID 13 - Радужный кейс (+4% к предметам, -4% к минусу)
            ('🌈 Радужный кейс', 30000, json.dumps([
                {'type': 'coins', 'amount': [15000, 25000], 'chance': 0.25, 'description': 'Радужные монеты'},   # 0%
                {'type': 'special_item', 'name': 'Слот-мастер', 'chance': 0.24, 'description': '+25% к выигрышу в слотах'},  # +4%
                {'type': 'bonus', 'multiplier': 6.0, 'duration': 216, 'chance': 0.1, 'description': 'Временный бонус x6.0 на 216 часов'},  # 0%
                {'type': 'coins', 'amount': [-12000, -8000], 'chance': 0.06, 'description': 'Радужный риск'},    # -4%
                {'type': 'coins', 'amount': [25001, 40000], 'chance': 0.15, 'description': 'Радужный выигрыш'},  # 0%
                {'type': 'special_item', 'name': 'Счастливая монета', 'chance': 0.2, 'description': '+20% к выигрышу в coinflip'}  # 0%
            ])),
            # ID 14 - Кровавый кейс (+4% к предметам, -4% к минусу)
            ('🩸 Кровавый кейс', 40000, json.dumps([
                {'type': 'coins', 'amount': [18000, 30000], 'chance': 0.25, 'description': 'Кровавые монеты'},   # 0%
                {'type': 'special_item', 'name': 'Флакон зелья', 'chance': 0.24, 'description': '+20% к наградам за квесты'},  # +4%
                {'type': 'bonus', 'multiplier': 7.0, 'duration': 240, 'chance': 0.1, 'description': 'Временный бонус x7.0 на 240 часов'},  # 0%
                {'type': 'coins', 'amount': [-15000, -10000], 'chance': 0.06, 'description': 'Кровавые потери'}, # -4%
                {'type': 'coins', 'amount': [30001, 45000], 'chance': 0.15, 'description': 'Кровавый куш'},      # 0%
                {'type': 'special_item', 'name': 'Щит богатства', 'chance': 0.2, 'description': '-20% к проигрышам'}  # 0%
            ])),
            # ID 15 - Божественный кейс (+4% к предметам, -4% к минусу)
            ('🌟 Божественный кейс', 50000, json.dumps([
                {'type': 'coins', 'amount': [25000, 50000], 'chance': 0.2, 'description': 'Божественные монеты'}, # 0%
                {'type': 'special_item', 'name': 'Зелье удачи', 'chance': 0.24, 'description': '+10% ко всем наградам'},  # +4%
                {'type': 'bonus', 'multiplier': 8.0, 'duration': 288, 'chance': 0.1, 'description': 'Временный бонус x8.0 на 288 часов'},  # 0%
                {'type': 'coins', 'amount': [-20000, -12000], 'chance': 0.06, 'description': 'Божественные потери'}, # -4%
                {'type': 'coins', 'amount': [50001, 80000], 'chance': 0.15, 'description': 'Божественный куш'},   # 0%
                {'type': 'special_item', 'name': 'Древний артефакт', 'chance': 0.25, 'description': 'Мощный множитель наград x1.5'}  # 0%
            ]))
        ]
        
        # Вставляем улучшенные кейсы
